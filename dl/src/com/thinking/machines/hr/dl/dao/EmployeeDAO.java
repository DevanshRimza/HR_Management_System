...
if(employeeId==null) throw new DAOException("Length of Employee Id. is zero");
String name=employeeDTO.getName();
if(name==null) throw new DAOException("Name is null");
name=name.trim();
if(name.length()==0) throw new DAOException("Length of name is zero");
...
if(employeeId.length()==0) throw new DAOException("Invalid employeeId. :  employee is of zero length");
try
{
File file=new File(FILE_NAME);
